...
def run_one_image(uploaded_file, api_key, workspace, workflow, run_id, run_started_at, retries, sleep_sec):
    last_error = ""
...
if uploaded_files:
    ...
    if st.button("Start Batch Analysis", type="primary"):
        ...
        with ThreadPoolExecutor(max_workers=workers) as executor:
            future_to_file = {
                executor.submit(
                    run_one_image, file, user_api_key, workspace_name, workflow_id, 
